...
if(checkloggedin())
{
    ...
    if(isset($_POST['submit']))
    {
        ...
        if($errors == 0)
        {
            ...
            transfer($link['ACCOUNT_VERIFICATION_DETAILS'],$lang['SETTING_SAVED_SUCCESS'],$lang['SETTING_SAVED']);
            exit;
        }
    }

    $page = new HtmlTemplate ("templates/" . $config['tpl_name'] . "/account-verification-details.tpl");
    $page->SetParameter ('OVERALL_HEADER', create_header($lang['ACCOUNT_VERIFICATION_DETAILS']));
    if(isset($_POST['submit']))
    {
