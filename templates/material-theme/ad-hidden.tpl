...
<div id="page-content">
    <div class="container">
        <ul class="breadcrumb bcstyle2">
            ...
            <li class="active"><a>{LANG_HIDDEN_ADS}</a></li>
        </ul>
        <a href="{LINK_POST-AD}" class="postadinner"><span> <i class="fa fa-plus-circle"></i> {LANG_POST_AD}</span></a>
        <!--end breadcrumb-->
        <section class="page-title center"><h1>{LANG_HIDDEN_ADS}</h1></section>
        <!--end page-title-->
        <section>
            <div class="row mt40">
                <!-- Page-Sidebar -->
                ...
                <div class="col-sm-9 page-content">
                    <div class="inner-box"><h1>{LANG_HIDDEN_ADS} </h1>
                        ...
                        <div class="table-responsive">
                            ...
                            <table id="js-table-list" class="table table-striped table-bordered add-manage-table table demo footable-loaded footable" data-filter="#filter" data-filter-text-only="true">
                                ...
                                <tbody>
                                {LOOP: ITEM}
                                <tr class="ajax-item-listing IF("{ITEM.status}"=="hide"){ opapcityLight {:IF}" data-item-id="{ITEM.id}" data-item-id="{ITEM.id}" data-search-term="{ITEM.product_name}">
