...
<head>
    ...
    <link href="{SITE_URL}plugins/wchat/assets/bootstrap/dist/css/bootstrap.min.css" rel="stylesheet" type="text/css">
    <!-- Animation CSS -->
    <link href="{SITE_URL}plugins/wchat/assets/css/animate.css" rel="stylesheet" type="text/css">
    <link href="{SITE_URL}plugins/wchat/assets/css/custom.css" rel="stylesheet" id="style" type="text/css">
    <!-- Emoji One JS -->
    <link rel="stylesheet" href="{SITE_URL}plugins/wchat/smiley/assets/sprites/emojione.sprites.css" type="text/css"/>

    <script src="{SITE_URL}plugins/wchat/chatjs/jquery.min.js"></script>
...
<script src="{SITE_URL}plugins/wchat/smiley/js/emojione.min.js"></script>
...
<script type="text/javascript">
    ...
    emojione.imagePathPNG = '{SITE_URL}plugins/wchat/smiley/assets/png/';
    emojione.imagePathSVG = '{SITE_URL}plugins/wchat/smiley/assets/svg/';
...
<!--File Uploader css-->
<link rel="stylesheet" href="{SITE_URL}plugins/wchat/plugins/uploader/jquery.ui.plupload/css/jquery-ui.css"
      type="text/css"/>
<link rel="stylesheet" href="{SITE_URL}plugins/wchat/plugins/uploader/jquery.ui.plupload/css/jquery.ui.plupload.css"
      type="text/css"/>
<!--File Uploader css-->
...
<div id="header">
    <div class="container">
        ...
        <a href="{LINK_DASHBOARD}">{LANG_DASHBOARD}</a>
    </div>
</div>
<div id="wchat-rtl"></div>
        ...
        <div class="pane pane-intro" id="pane-intro" style="visibility: visible">
          <div class="intro-body">
            ...
            <div class="intro-text-container" style="opacity: 1; transform: translateY(0px);">
              <h1 class="intro-title">Welcome to chat {USERNAME}</h1>
              <div class="intro-text">No Conversation sync. Please search users and start chat.</div>
            </div>
          </div>
        </div>
          ...
          <header class="wchat-header">
            ...
            <div class="header-body">
              <div class="header-main">
                <div class="header-title">{LANG_PROFILE}</div>
              </div>
            </div>
          </header>
                            ...
                            <div class="chat-avatar">
                                <div class="avatar icon-user-default" style="height: 40px; width: 40px;">
                                    <div class="avatar-body userimage"><img
                                                src="{SITE_URL}storage/profile/small_{USERIMG}"
            ...
            <div id="main right" class="pane wchat-chat wchat-two chat-right-aside right" style="visibility: hidden;">
                ...
                <header class="wchat-header wchat-chat-header top" data-user="">
                    ...
                    <div class="chat-body">
                        ...
                        <div class="chat-status wchatellips" id="typing_on"><!--last seen today at 8:52 PM--></div>
                    </div>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <div class="white-box text-center bg-purple uploadFile" id="uploadFile">
                                                    <a href="#" class="text-white" data-toggle="tooltip" title=""
                                                       data-original-title="{LANG_PHOTOS}"><i
                                            ...
                                            <div class="col-sm-12">
                                                <div class="white-box text-center bg-success uploadFile"><a href="#"
                                                                                                            ...
                                                                                                            data-toggle="tooltip"
                                                                                                            title=""
                                                                                                            data-original-title="{LANG_VIDEOS}"><i
                                            ...
                                            <div class="col-sm-12">
                                                <div class="white-box text-center bg-info uploadFile"><a href="#"
                                                                                                         ...
                                                                                                         data-toggle="tooltip"
                                                                                                         title=""
                                                                                                         data-original-title="{LANG_DOCUMENTS}"><i
                            ...
                            <div class="menu-item active dropdown pull-right">
                                ...
                                <ul class="dropdown-menu dropdown-user animated flipInY">
                                    <li><a href="#" onclick="javascript:ShowProfile();"><i
                                                    class="ti-user"></i> {LANG_VIEW_PROFILE}</a></li>
                                    <li><a href="{LINK_DASHBOARD}"><i class="ti-wallet"></i> {LANG_DASHBOARD}</a></li>
                                    <li><a href="{LINK_LOGOUT}"><i class="fa fa-power-off"></i> {LANG_LOGOUT}</a></li>
                                </ul>
                                <!-- /.dropdown-user --></div>
...
<script src="{SITE_URL}plugins/wchat/assets/bootstrap/dist/js/bootstrap.min.js"></script>

<!-- Media Uploader -->
<!--This div for modal light box chat box image-->
<div id="lightbox" style="display: none;">
    <p><img src="{SITE_URL}plugins/wchat/plugins/images/close-icon-white.png"
            width="30px" style="cursor: pointer"/></p>
    <div id="content"><img src="#"/></div>
</div>
<!--This div for modal light box chat box image-->

<!-- jQuery -->
<script src="{SITE_URL}plugins/wchat/plugins/bower_components/jquery/dist/jquery.min.js"></script>

<!-- Custom Theme JavaScript -->
<script src="{SITE_URL}plugins/wchat/assets/js/custom.js"></script>
<!--Style Switcher -->
...
<script>
    var siteurl = '{SITE_URL}';
    var filename = '{WCHAT_SECRET_FILE}.php';
    var plugin_directory = 'plugins/wchat/' + filename;
    // Chat start with
    var chatusername = "{CHAT_USERNAME}";
    var chatuserid = "{CHAT_USER_ID}";
    var chatuserimg = "{CHAT_USERIMG}";
    var session_uname = '{USERNAME}';
    var session_img = '{USERIMG}';
    // Language Var
...
<script type="text/javascript" src="{SITE_URL}plugins/wchat/chatjs/lightbox.js"></script>
<script type="text/javascript" src="{SITE_URL}plugins/wchat/chatjs/inbox.js"></script>
<script type="text/javascript" src="{SITE_URL}plugins/wchat/chatjs/custom.js"></script>
<!--ChatJs-->
<!-- Media Uploader -->
<script type="text/javascript" src="//ajax.googleapis.com/ajax/libs/jqueryui/1.10.2/jquery-ui.min.js"></script>
<script type="text/javascript" src="{SITE_URL}plugins/wchat/plugins/uploader/plupload.full.min.js"></script>
<script type="text/javascript"
        src="{SITE_URL}plugins/wchat/plugins/uploader/jquery.ui.plupload/jquery.ui.plupload.js"></script>
<script type="text/javascript"
...
<script type="text/javascript">
    if ($("body").hasClass("rtl")) {
        $('#wchat-rtl').append('<link rel="stylesheet" type="text/css" href="{SITE_URL}plugins/wchat/assets/css/wchat-rtl.css">');
    }

    $(window).bind("load", function () {

        if (chatusername != '' && chatuserid != '') {
            chatWith(chatusername, chatuserid, session_img, 'Offline');
            $('.right .top .personName').html(chatusername);
            $('.right .top .userimage').html('<img src="' + siteurl + 'storage/profile/' + chatuserimg + '" alt="' + chatusername + '" class="avatar-image is-loaded bg-theme" width="100%">');
        } else {
