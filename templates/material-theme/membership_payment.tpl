                            ...
                            <div class="payment">
                                ...
                                {:IF}
                                    ...
                                    <div class="payment-tab">
                                        <div class="payment-tab-trigger">
                                            <input name="payment_method_id" class="payment_method_id" id="{PAYMENT_TYPES.folder}" type="radio" value="{PAYMENT_TYPES.id}" data-name="paytm">
                                            <label for="{PAYMENT_TYPES.folder}">{PAYMENT_TYPES.title}</label>
                                            <img class="payment-logo {PAYMENT_TYPES.folder}" src="{SITE_URL}includes/payments/{PAYMENT_TYPES.folder}/logo/logo.png" alt="">
                                        </div>
                                ...
                                {:IF}
                                    ...
                                    <div class="payment-tab">
                                        ...
                                        <div class="payment-tab-trigger">
                                            ...
                                            <img class="payment-logo" src="{SITE_URL}includes/payments/{PAYMENT_TYPES.folder}/logo/logo.png" alt="">
                                        </div>
                                        <div class="payment-tab-content">
...
<script>
    $(document).ready(function ()
    {
        ...
        $('#subscribeNow').on('click', function (e)
        {
            ...
            if (paymentMethod != 'paytm' || packagePrice <= 0) {
                return false;
            }
