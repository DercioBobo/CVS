                                    ...
                                    <div id='custom-field-block IF("{SHOWCUSTOMFIELD}"!="1"){ hidden {:IF}'>
                                        <div id="ResponseCustomFields">
                                            ...
                                            <div class="row form-group {CUSTOMFIELDS.title}">
                                                <label class="col-sm-3 label-title">{CUSTOMFIELDS.title}</label>
                                                <div class="col-sm-9">
                                                    <select class="form-control quick-select" name="custom[{CUSTOMFIELDS.id}]" data-name="{CUSTOMFIELDS.id}"
                                    ...
                                    <div class="row form-group" id="quickad-price-field">
                                        ...
                                        <div class="col-sm-9">
                                            <div class="input-group custom-input-group">
                                                ...
                                                <input type="text" class="form-control" placeholder="ex: 1000" name="price">
                                            </div>
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <div class="input-group custom-input-group">
                                                ...
                                                <input type="text" class="form-control" placeholder="ex: 848287935" name="phone">
                                            </div>
                                            <label class="btn border-left-zero label-adon">
                                        ...
                                        <ol>
                                            <li class="form-step">
                                                <div class="tg-inputwithicon">
                                                    ...
                                                    <div class="map height-200px shadow" id="singleListingMap" data-latitude="{LATITUDE}" data-longitude="{LONGITUDE}" style="height: 200px"></div>
