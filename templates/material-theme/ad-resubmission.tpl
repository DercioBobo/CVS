...
<div id="page-content">
    <div class="container">
        <ul class="breadcrumb bcstyle2">
            ...
            <li class="active"><a>{LANG_RESUBMITED_ADS}</a></li>
        </ul>
        <a href="{LINK_POST-AD}" class="postadinner"><span> <i class="fa fa-plus-circle"></i> {LANG_POST_AD}</span></a>
        <!--end breadcrumb-->
        <section class="page-title center"><h1>{LANG_RESUBMITED_ADS}</h1></section>
        <!--end page-title-->
        <section>
            <div class="row mt40">
                                ...
                                <div class="collapse-box"><h5 class="collapse-title"> {LANG_MY_ADS} <a class="pull-right" data-toggle="collapse" href="#MyAds"><i class="fa fa-angle-down"></i></a></h5>
                                    ...
                                    <div id="MyAds" class="panel-collapse collapse in">
                                        <ul class="acc-list">
                                            ...
                                            <li class="active"><a href="{LINK_RESUBMITADS}" class="waves-effect"><i class="fa fa-flag"></i> {LANG_RESUBMITED_ADS} <span class="badge">{RESUBMITADS}</span></a></li>
                                        </ul>
                                    </div>
                                </div>
                                <div class="collapse-box">
                ...
                <div class="col-sm-9 page-content">
                    <div class="inner-box"><h1>{LANG_RESUBMITED_ADS} </h1>
                        ...
                        <div class="table-responsive">
                            ...
                            <table id="js-table-list" class="table table-striped table-bordered add-manage-table table demo footable-loaded footable" data-filter="#filter" data-filter-text-only="true">
                                ...
                                <tbody>
                                {LOOP: ITEM}
                                <tr class="ajax-item-listing" data-item-id="{ITEM.id}" data-search-term="{ITEM.product_name}">
                                    ...
                                    <td class="price-td width-16-per">
                                        <div>
                                            <span class="label label-success">{LANG_RESUBMITED}</span>
                                        </div>
                                    </td>
                                    <td class="price-td width-16-per">
                                    ...
                                    <td class="action-td width-10-per">
                                        <div>
                                            <p class="opacity1">
                                            <a class="btn btn-danger btn-rounded btn-xs item-js-delete" href="#" data-ajax-action="deleteResumitAd"><i class=" fa fa-trash-o"></i> {LANG_DELETE}</a>
                                        </p></div>
                                    </td>
                                </tr>
                                {/LOOP: ITEM}
