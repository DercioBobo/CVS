...
<div id="page-content">
    <div class="container">
        <ul class="breadcrumb bcstyle2">
            ...
            <li class="active"><a>{LANG_EXPIRE_ADS}</a></li>
        </ul>
        <a href="{LINK_POST-AD}" class="postadinner"><span> <i class="fa fa-plus-circle"></i> {LANG_POST_AD}</span></a>
        <!--end breadcrumb-->
        <section class="page-title center"><h1>{LANG_EXPIRE_ADS}</h1></section>
        <!--end page-title-->
        <section>
            <div class="row mt40">
                ...
                <div class="col-sm-9 page-content">
                    <div class="inner-box"><h1>{LANG_EXPIRE_ADS} </h1>
                                ...
                                <tr class="ajax-item-listing" data-item-id="{ITEM.id}" data-search-term="{ITEM.product_name}">
                                    ...
                                    <td class="action-td width-10-per">
                                        <div><p class="opacity1">
                                            <a class="btn btn-info btn-rounded btn-xs" href="{LINK_EDIT-AD}/{ITEM.id}" data-ajax-action="deleteMyAd"><i class=" fa fa-pencil"></i> {LANG_RENEW}</a>
                                        </p><p class="opacity1">
