            ...
            <tr class="_51mx">
                <td class="_51m- phm" style="width:78%">
                    <span class="uiIconText">
                        ...
                        <span class="pts5 fsl fwb fs13 fbold">{LANG_WELCOME} <span class="coffel">{USERNAME}</span>, Va para seu email <span class="coffel">{USEREMAIL}</span> e {LANG_VERIFY_EMAIL_ADDRESS}</span>
                    </span>
                </td>
...
<div class="page-wrapper" id="page-header">
    ...
    <header class="header-section-default header-main nav-left header-fixed hidden-sm hidden-xs">
        <div class="container">
            ...
            <div class="header-right">
                IF("{LOGGED_IN}"=="0"){
                <div class="user">
                    <a href="#" data-toggle="modal" data-target="#loginPopUp" class="waves-effect pad-lr-10 modal-trigger">Login</a>
                ...
                <ul class="account-action">
                    <li>
                        ...
                        <div class="account-dropdown">
                            <ul>
                                IF("{LOGGED_IN}"=="0"){
                                <li><a href="{LINK_LOGIN}" class="waves-effect"><i class="fa fa-user"></i> Login</a></li>
